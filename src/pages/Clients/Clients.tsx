...
import { fetchClient } from "../../stores/ClientActions";
...
function Clients() {
  ...
  const {  Clients, loading, error, success } = useSelector(
              ...
              {Clients?.map((client: any, key: any) => (
                <tr key={key}>
                  <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark ">
                    <p className="text-black dark:text-black">{client?.nom}</p>
                  </td>
                  <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  ...
                  <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark ">
                    <div className="flex-shrink-0 w-10">
                      <img
                        src={process.env.API_URL + client?.photo}
                        alt="image"
                      />
                    </div>
                  </td>
